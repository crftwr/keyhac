...
- Tray / menu-bar extra (`keyhac/ui/tray.py`): menu (console / reload / hook
  ...
  into `keyhac/ui/assets/`: color `keyhac.ico` for the Windows tray, grayscale
  `MenuExtraTemplate[@2x].png` for macOS (AppKit template: alpha carries the
  face shading, system recolors for dark mode). Needs puikit's
